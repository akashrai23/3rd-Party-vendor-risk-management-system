...
<body>
    <div class="container">
        <div class = "row">
            ...
            <h1 class="col-md-5 offset-1 col-10 align-self-center" style="text-align: center; font-family:Audiowide, sans-serif;font-weight: 400;font-style: normal;">Third Party Vendor Risk Management System</h1>
            <div class="col-md-4 align-self-center" style="text-align: right; ">
                <h4 style="text-align: center; font-family:Audiowide, sans-serif;font-style: normal;" > Welcome <?php echo $_SESSION["user"] ?>!</h4>
                <a href="php/sign_out.php" style="text-align: center; font-family:Audiowide, sans-serif;font-style: normal;">Sign Out</a>
    </div>
    
    <section class="container" style="margin-top: 24px;">
        <div class="row" style="font-family:Audiowide, sans-serif;font-weight: 400;font-style: normal;">
        ...
        <div class="row">
            ...
            <form class="col-10 offset-1" action = "php/add-client.php" method="POST">
                <div class="row">
                    ...
                    <input class="col-md-6 offset-md-2 align-self-center"  type="number" name="id" id="id"  >
                </div>
                <div class="row">
...
<section class="container"  id="report">
    <h2  style="text-align: center; font-family:Audiowide, sans-serif;font-weight: 400;font-style: normal;">Reports</h2>
        <h4  style="font-family:Audiowide, sans-serif;font-weight: 400;font-style: normal;">🔴Renew the Contract<br></h4>
        <h4 style="font-family:Audiowide, sans-serif;font-weight: 400;font-style: normal;">🟢Low risk</h4>

    
    <hr>
       <?php
        $con = mysqli_connect("localhost", "root","","cms");
        $query1 = "SELECT DISTINCT* FROM vendors 
           LEFT JOIN employees ON vendors.employee_id = employees.employee_id
           JOIN bg_info ON vendors.id = bg_info.id";

        $result1 = mysqli_query($con,$query1);

        $query2 ="SELECT DISTINCT * FROM clients 
           LEFT JOIN employees ON clients.employee_id = employees.employee_id
           JOIN bg_info ON clients.id = bg_info.id";
       ...
       ?>
    <h4 style="font-family:Audiowide, sans-serif;font-weight: 400;font-style: normal;">Vendors</h4>
    <div class="table-responsive" style="background-color:#0489981a; border-radius: 15px;">
        <table class="table table-bordered table-hover">
                <thead>
                  <tr style="font-family:Audiowide, sans-serif;font-weight: 400;font-style: normal;">
                ...
                <?php  while($rows = mysqli_fetch_assoc($result1)){ ?>
                    <tr>
                        ...
                        <td><?php echo $rows['compliancestatus'] ?></td>
    ...
    <h4 style="font-family:Audiowide, sans-serif;font-weight: 400;font-style: normal;">Clients</h4>
    <div class="table-responsive" style="background-color:#0489981a; border-radius: 15px;">
        <table class="table table-bordered table-hover">
                <thead>
                  <tr style="font-family:Audiowide, sans-serif;font-weight: 400;font-style: normal;">
