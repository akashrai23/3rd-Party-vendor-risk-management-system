...
$info_query = "INSERT INTO clients(employee_id, id, name, project_name, start_date ,end_date, work_no, client_date, vendor, remarks) VALUES($employee_id, $id, '$name','$project_name', '$start_date', '$end_date', $work_no, '$client_date', $vendor, '$remarks')";
echo $info_query;
$info_result = mysqli_query($con, $info_query);

if($confirmation == "Yes"){
    $bg_query = "INSERT INTO bg_info VALUES($employee_id, $bg_no, $bg_amount, '$bg_date', '$bg_expiry_date', '$confirmation', '$confirm_date')";
}else{
