...
$info_query = "INSERT INTO vendors(employee_id, id, name, project_name, start_date, end_date, client, remarks) VALUES($employee_id, $id, '$name', '$project_name', '$start_date', '$end_date', $client, '$remarks')"; 
